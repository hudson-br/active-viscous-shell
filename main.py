...
with open("/lustre/home/hudson.borja/Nematic/paths.json") as json_file:
...
#     ], shell = True
# )
subprocess.call([paths["gmsh"], "-2", "-format", "msh2", "../../" + geometry + ".geo", "-o", xdmf_name.replace("xdmf", "msh")]) # Jeremy's
