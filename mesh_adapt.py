...
def mesh_adapt(mmg_path, gmsh_path, control_type):
    ...
    # os.system("meshio info mesh.xdmf")
    os.system(
        "meshio convert --input-format xdmf --output-format medit mesh.xdmf mesh.mesh"
    )
    # subprocess.call(['meshio convert     mesh.xdmf mesh.mesh'], shell = True)
    # print("This is done")
    ...
    #     os.system("../../bin/mmgs_O3 -in mesh.mesh -out mesh_optimized.mesh -hausd {}".format(dist))
    ...
    # os.system('gmsh -2 -format msh2 mesh_optimized.mesh -o mesh_optimized.msh') 
