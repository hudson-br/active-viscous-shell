...
#
folder_path = '/lustre/home/hudson.borja/Nematic/'
script = '/lustre/home/hudson.borja/Nematic/main.py'
...
#    f.write('#SBATCH --hint=nomultithread\n')
    ...
    f.write('spack load py-h5py%gcc@9.3.1\n')
    f.write('spack load gmsh%gcc@9.3.1\n')
    
    # Remeshing with mmg
    f.write('spack load mmg%gcc@9.3.1\n')
    f.write('export MMG="/share/softs/spack/opt/spack/linux-centos7-skylake_avx512/gcc-9.3.1/mmg-5.6.0-ditifd5omaaxh5pbslr4mpbznixrsotb/bin"\n')
    
    # For meshio that was installed locally with py-pip
    f.write('export PATH="/lustre/home/hudson.borja/.local/bin:$PATH"\n')
    f.write('python3 /lustre/home/hudson.borja/Nematic/main.py config.conf\n')
    f.close()
...
def write_s(confname, script, dirconfig, n) :
    ...
    # Remeshing with mmg
    f.write('spack load mmg%gcc@9.3.1\n')
    f.write('export MMG="/share/softs/spack/opt/spack/linux-centos7-skylake_avx512/gcc-9.3.1/gcc-9.3.1/mmg-5.6.0-7gqt2uvbe3abajuuarwupr324psm6hur/bin"\n')
    
    # For meshio that was installed locally with py-pip
    f.write('export PATH="/lustre/home/hudson.borja/.local/bin:$PATH"\n')
    f.write('cd ' + dirconfig + '/\n')
    f.write('python3 ' + script)
